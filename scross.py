		...
		for i in range(len(v_max)):
			...
			if indice_inicio_resp-1000>=0:
				...
				if resp_archivo_existe1 == 1 and resp_archivo_existe2 == 1 and resp_archivo_existe3 == 1:
					...
					Indice_inicial=indice_inicio_resp-500
					Indice_final=(indice_inicio_resp)+len(self.senal02)
					inicio_cut=Cut_Sac()
					...
					if respuesta_picker != -1:
						...
						opcion=0
						Inicia_guardar_archivos.crea_nombre(path1, path2, nombre_path_resultados, nombre_guardar, Indice_inicial, Indice_final, v_max[i], opcion, respuesta_picker,respuesta_picker_E, respuesta_picker_N )	
