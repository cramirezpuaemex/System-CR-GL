	...
	def main(self, indicei, indicef, dia_a):
		...
		for j in range(len(dia)):
			...
			for i in range(len(estaciones)):
				...
				s=''
				path1='/home/carlos/Escritorio/CODEX_2006/'+dia[j]+'/ZA.'+estaciones[i]+'..HHZ.M.2006.'+dia[j]+'.000000.SAC'
				#print path1
				pathE='/home/carlos/Escritorio/CODEX_2006/'+dia[j]+'/ZA.'+estaciones[i]+'..HHE.M.2006.'+dia[j]+'.000000.SAC'
				pathN='/home/carlos/Escritorio/CODEX_2006/'+dia[j]+'/ZA.'+estaciones[i]+'..HHN.M.2006.'+dia[j]+'.000000.SAC'
				s = "echo on\n"
				line1='read '+path1+'\n'
		...
		if len(names)>2:
			delay=[]
			suma=0
			print 'len(time_arrive)', len(time_arrive), time_arrive
			...
			for i in range(len(delay)):
				nombre_del_archivo=time_arrive[i][0:16]
				
				nombre_del_archivo=nombre_del_archivo.replace(" ", ".")
				print 'name', nombre_del_archivo

				hora_archivo=time_arrive[i][11:13]
				print 'hora_archivo', hora_archivo
				minutos_archivo=time_arrive[i][14:16]
				print 'minutos_archivo', minutos_archivo
				station=names[i][0:4]
				...
				#path_salve_dia='/home/carlos/Escritorio/Resultados/'+dia_a
				...
				if os.path.isfile(path2):
					...
					path11='/home/carlos/Escritorio/CODEX_2006/'+dia_a+'/ZA.'+station+'..HHZ.M.2006.'+dia_a+'.000000.SAC'
					#print path1
					pathE1='/home/carlos/Escritorio/CODEX_2006/'+dia_a+'/ZA.'+station+'..HHE.M.2006.'+dia_a+'.000000.SAC'
					pathN1='/home/carlos/Escritorio/CODEX_2006/'+dia_a+'/ZA.'+station+'..HHN.M.2006.'+dia_a+'.000000.SAC'
