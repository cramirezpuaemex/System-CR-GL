...
# Use una caracteristica
diabetes_X = diabetes.data[:, np.newaxis, 2]
# Divide los datos en conjuntos de formacion/pruebas
diabetes_X_train = diabetes_X[:-50]
diabetes_X_test = diabetes_X[-50:]
# Dividir los objetivos en conjuntos de formacion/pruebas
...
# Puntuacion de varianza explicada: 1 es una prediccion perfecta
